...
public class App
{
    ...
    public static void main(String[] args)
    {
        ...
        String numberString = prog.getInput();

        String[] numbers = numberString.split(" ");
        ArrayList<Integer> numberList = new ArrayList<Integer>();

        prog.getEvenNums(numberList, numbers);

        prog.printOutput(numberList);
    }

    private void getEvenNums(ArrayList<Integer> numberList, String[] numbers)
    {
        int num;
    ...
    private void printOutput(ArrayList<Integer> number)
    {
